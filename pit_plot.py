...
def main_prapr():
    ...
    utils.line_plot(res, 'prapr_expected_valid_others', 'probability', 'valid', 'Number of valid patches', 'project',
                    x_label='Nominal Flake Rate')
    utils.line_plot(res, 'valid_patches_std', 'probability', 'std', 'Standard Deviation n', 'project',
                    x_label='Nominal Flake Rate')
